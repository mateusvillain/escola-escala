...
- Pix: continua adiado pelo motivo original (convite da Stripe pendente para contas BR, ver `docs/pix-habilitacao.md`) — independente da remoção de Boleto, que teve motivo diferente (gap de tratamento assíncrono, não bloqueio externo)
