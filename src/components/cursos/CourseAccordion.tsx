          ...
          <div key={module.id} className="bg-white">
            ...
            >
              <div className="flex items-center gap-3 min-w-0">
                ...
                <span className="text-sm font-semibold text-gray-900 truncate">{module.title}</span>
                {!module.isReleased && (
                  <span className="flex-shrink-0 flex items-center gap-1 px-2 py-0.5 rounded-full bg-gray-100 text-gray-500 text-xs font-medium">
                    <LockIcon />
                    {module.releaseLabel}
                  </span>
                )}
            ...
            {isOpen && (
              <ul className="divide-y divide-gray-50 bg-gray-50">
                {module.lessons.map(lesson => {
                  const isAccessible = (hasAccess && module.isReleased) || lesson.isPreview
